    ...
    return (
        ...
        >   
            ...
            <Box display={'flex'} justifyContent={'center'} alignItems={'center'} mb={'1.5'}>
                <Text mr={'2.5'}><a href="https://github.com/catppuccin/catppuccin#-palette" color='white'>Palette </a></Text>
                <Text mr={'2.5'}><a href="https://github.com/catppuccin/catppuccin#-ports-and-more">Ports </a></Text>
                <Text><a href="https://github.com/catppuccin/catppuccin#-design-philosophy">Design Philosophy</a></Text>
            </Box>
            <Box display={'flex'} justifyContent={'center'} alignItems={'center'} mb={'1.5'}>
