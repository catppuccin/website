...
external link icon was removed and therefore the need for the component itself.

## What does the icon _really_ mean?

Moving away from the technical complexity, an important question we didn't think
to ask ourselves was _"What does the icon really mean?"_.
...
There are numerous sources online ~~debating~~ discussing what this icon should
indicate. One of the strongest arguments for removing it is from the U.K
government who decided to remove the icon from their design system in 2016:
...
TODO: Talk about our final decision to remove the external icon for good and
relying on good 'ol CSS to style links across the website.
