      ...
      <div className="font-inter">
        <div className="max-w-3xl mx-auto p-4">
          <div className="gap-6 flex flex-col pb-8">
            ...
            <img className="mx-auto" src="https://raw.githubusercontent.com/catppuccin/catppuccin/main/assets/palette/macchiato.png" width="400" alt="Macchiato Palette"/>
            <div className="flex flex-col items-center md:flex-row justify-between gap-2">
              <a href="https://github.com/catppuccin/catppuccin/stargazers">
                <img alt="Stargazers" src="https://img.shields.io/github/stars/catppuccin/catppuccin?style=for-the-badge&logo=starship&color=C9CBFF&logoColor=D9E0EE&labelColor=302D41"/>
              </a>
          ...
          <div className="prose lg:prose-lg" dangerouslySetInnerHTML={{__html: content}}/>
        </div>
      </div>
    </Layout>
  );
